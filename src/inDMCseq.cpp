...
void showHelp() {
    std::cout << "DMC model simulation\n"
                 ...
                 "Examples:\n"
                 "./dmcSimSeq           // Results from Figure 3\n"
                 "./dmcSimSeq --tau 150 // Results from Figure 4\n"
                 "./dmcSimSeq --tau 90  // Results from Figure 5\n"
                 "./dmcSimSeq --varDR 1 // Results from Figure 6\n"
                 "./dmcSimSeq --varSP 1 // Results from Figure 7" << std::endl;
}
